...
public class MealsUtil {
    public static void main(String[] args) {
        Meals mealsDAO =  new MealMemoryStorage();
        List<MealWithExceed> mealsWithExceeded = getFilteredWithExceeded(mealsDAO.getAll(), LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
        mealsWithExceeded.forEach(System.out::println);

        System.out.println(getFilteredWithExceededByCycle(mealsDAO.getAll(), LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
        System.out.println(getFilteredWithExceededInOnePass(mealsDAO.getAll(), LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
        System.out.println(getFilteredWithExceededInOnePass2(mealsDAO.getAll(), LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
    }
